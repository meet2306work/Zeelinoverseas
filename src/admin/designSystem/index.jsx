            ...
            <div className="border-t border-slate-200 dark:border-slate-800 pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Shipping Destination</label>
                  <input
                    type="text"
                ...
                {/* SKU Code Input */}
                <div className="flex flex-col gap-2">
                  <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">SKU / Product Code (focused)</label>
                  <input
                    type="text"
                    defaultValue="BOX-L-BRN-01"
